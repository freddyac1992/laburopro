...
export default function FavoriteButton({
  ...
  return (
    <button
      ...
      className={`press-feedback min-h-11 min-w-11 inline-flex items-center justify-center gap-2 border bg-white hover:border-red-300 focus-visible:outline-red-600 ${
